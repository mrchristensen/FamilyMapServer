...
//        server.createContext("/event/[eventID]", new EventIDRequestHandler()); //This API will return the single event with the specified ID. The event must belong to a relative of the user associated with the authorization authToken. The returned JSON contains the requested event object. Authorization authToken is required.
